...
class MainViewModel @Inject constructor(
            ...
            is MainEvent.OnSearchClick -> {
                ...
                searchJob = viewModelScope.launch {
                    loadWordResult(
                        ...
                        category = mainState.value.selectedCategory
                    )
                }
            }
    ...
    private fun loadWordResult(context: Context, word: String, category: DictionaryCategory) {
        viewModelScope.launch {
            repository.getWordResult(word = word, category = category)
